...
/**
 * Runs the agent loop and compacts oversized context before model calls.
 *
 * @author zhaobinjie
 * @date 2026-06-25
 */
public class AgentEngine {
    ...
    private final Compactor compactor = new Compactor(3_000, 6);
