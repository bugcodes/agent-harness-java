...
/**
 * Runs the chapter five loop with optional thinking and registered local tools.
 *
 * @author zhaobinjie
 * @date 2026-06-24
 */
public class AgentEngine {
    ...
    public AgentEngine(
            LlmProvider provider, ToolRegistry registry, String workDir, boolean enableThinking) {
